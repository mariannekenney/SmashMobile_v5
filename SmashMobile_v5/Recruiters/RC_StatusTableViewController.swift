...
class RC_StatusTableViewCell: UITableViewCell {
...
class RC_StatusTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> RC_StatusTableViewCell {
        let cell: RC_StatusTableViewCell = tableView.dequeueReusableCell(withIdentifier: "statusCell", for : indexPath) as! RC_StatusTableViewCell
